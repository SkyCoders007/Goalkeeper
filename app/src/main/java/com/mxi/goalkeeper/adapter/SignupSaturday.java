 ...
 */
public class SignupSaturday extends RecyclerView.Adapter<SignupSaturday.CustomViewHolder> {

    private Context context;
    private ArrayList<saturday> arrayList;
    CommanClass cc;

    public SignupSaturday(Context context, ArrayList<saturday> list) {
    ...
    public void onBindViewHolder(final CustomViewHolder holder, final int i) {
        ...
        final saturday list = arrayList.get(i);
            ...
            holder.iv_close.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!cc.loadPrefBoolean("islogin")) {
                        SignUp.saturdaylist.remove(i);
                    } else {
                        EditProfile.saturdaylist.remove(i);
                    }
