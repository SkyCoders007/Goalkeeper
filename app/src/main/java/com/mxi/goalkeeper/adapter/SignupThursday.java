 ...
 */
public class SignupThursday extends RecyclerView.Adapter<SignupThursday.CustomViewHolder> {

    private Context context;
    private ArrayList<thursday> arrayList;
    CommanClass cc;

    public SignupThursday(Context context, ArrayList<thursday> list) {
    ...
    public void onBindViewHolder(final CustomViewHolder holder, final int i) {
        ...
        final thursday list = arrayList.get(i);
            ...
            holder.iv_close.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!cc.loadPrefBoolean("islogin")) {
                        SignUp.thursdaylist.remove(i);
                    } else {
                        EditProfile.thursdaylist.remove(i);
                    }
